  ...
  <div class="flex">
    <div class="relative w-full">
      <input v-model="search"
             ...
             placeholder="Search"
      >
      <div class="absolute top-1/2 -translate-x-1/2 -translate-y-1/2 right-0.5" @click="clearInput">
        <close-icon/>
      </div>
    </div>


    <div class="border px-8 rounded-r-full bg-gray-100 relative " @click="searchVideo">
